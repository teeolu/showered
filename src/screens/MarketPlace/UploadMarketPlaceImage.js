...
import { Dimensions, View, TouchableOpacity, Platform, ImageBackground, ActivityIndicator } from 'react-native';
...
export class UploadMarketPlaceImage extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        const  setNewArray = () => {
            const newUploadedImageArray = [...this.props.uploadedImageArray];
    ...
    uploadImageAsync = async photo => {
        ...
        data.append("photo", {
            name: `${this.props.marketPlaceName.split(" ").join("_")}_image` || "",
            type: photo.type,
            uri:
